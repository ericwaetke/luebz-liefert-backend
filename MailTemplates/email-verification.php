...
<head>
    ...
    <title>E-Mail Adresse bestätigen - Lübz Liefert</title>
...
<body marginheight="0" marginwidth="0" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" bgcolor="#FFFFFF" style="margin:0;padding:0;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:none">
	<div style="display:none;font-size:1px;color:#FFFFFF;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden">
						<p>Fast geschafft! Bestätige nur noch diese Mail und dein Account ist einsatzbereit!</p>
		    </div>
				...
				<div mc:repeatable="Hero Section">
					...
					<tbody><tr>
						<td style="padding:0 30px" class="padded">
							...
							<tbody><tr>
								<td style="padding:20px 0;text-align:left;font-weight:500;font-size:24px;color:#343333" class="avenir" mc:edit="title">Hi '.$name.', du bist nur noch einen klick entfernt!</td>
							  </tr>
							  <tr>
								<td style="padding:0 80px 0 0;font-size:18px;line-height:167%;font-weight:400;color:#343333" mc:edit="copy 1">
									<p>Drücke den Knopf um deine E-Mail Adresse zu verifizieren - und dann wieder neues über Lübz erfahren 💪</p>
								</td>
							  </tr>
							  <tr>
								<td style="padding:30px 0 60px 0" mc:edit="button">
									...
									<div align="left">
										<a data-qa="verification_link" href="https://luebz-liefert.de/backend?verifyEmail='.$id.'" style="text-decoration:none;color:#FFFFFF;background-color:#343333;display:inline-block;padding:15px 20px;margin:auto;border:2px solid #343333;border-radius:3px;font-size:18px;font-weight:500" class="button">
											Verifiziere diese E-Mail Adresse
										</a>
									</div>
